...
WebUI.setText(findTestObject('Object Repository/Page_Innsight/input_Add collection_colloction_name (1)'), 'TC-003')
...
WebUI.click(findTestObject('Toggle Bars/Page_Innsight/div_Youtube_mat-slide-toggle-bar'))

WebUI.click(findTestObject('Toggle Bars/Page_Innsight/div_Youku_mat-slide-toggle-bar'))

WebUI.click(findTestObject('Toggle Bars/Page_Innsight/div_Weibo_mat-slide-toggle-bar'))

WebUI.click(findTestObject('Toggle Bars/Page_Innsight/div_Tiktok_mat-slide-toggle-bar'))

WebUI.click(findTestObject('Toggle Bars/Page_Innsight/div_Flickr_mat-slide-toggle-bar'))
