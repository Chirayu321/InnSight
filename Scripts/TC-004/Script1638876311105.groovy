...
WebUI.setText(findTestObject('Object Repository/TC_002/Page_INNSIGHT/input_Advance Filter_txtTwSrch'), 'india OR kashmir')
...
WebUI.click(findTestObject('TC004/Page_INNSIGHT/span_Twitter_checkmark'))
...
WebUI.click(findTestObject('TC004/Page_INNSIGHT/ALL'))
