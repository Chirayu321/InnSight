...
WebUI.click(findTestObject('10/Page_INNSIGHT/span_ORGANIZATION BEING TALKED ABOUT'))

WebUI.click(findTestObject('10/Page_INNSIGHT/span_PEOPLE BEING TALKED ABOUT'))
