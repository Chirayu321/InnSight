...
WebUI.setText(findTestObject('12/Page_INNSIGHT/AlertsName'), 'Riots')

WebUI.setText(findTestObject('12/Page_INNSIGHT/Keywords'), 'Riots , Dange ,Fights')
...
WebUI.selectOptionByValue(findTestObject('12/waste/Page_INNSIGHT/select_000102030405060708091011121314151617_d567da'), 
    '5', true)

WebUI.selectOptionByValue(findTestObject('12/waste/Page_INNSIGHT/select_000102030405060708091011121314151617_3a1c8f'), 
    '0', true)
