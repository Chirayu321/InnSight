...
WebUI.setText(findTestObject('27/Page_InnSight/input_Advance Filter_txtTwSrch'), 'india AND kashmir')

WebUI.click(findTestObject('27/Page_InnSight/a_Advance Filter  -'))

WebUI.click(findTestObject('Page_InnSight/span_News Paper_radiobtn'))
