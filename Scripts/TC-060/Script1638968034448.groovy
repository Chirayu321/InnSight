...
WebUI.click(findTestObject('Maps/Page_INNSIGHT/Map Icon'))

CustomKeywords.'utilities.main.pause'()

WebUI.click(findTestObject('Maps/Page_INNSIGHT/User Location'))

WebUI.click(findTestObject('Maps/Page_INNSIGHT/Article Location'))
