...
WebUI.click(findTestObject('scrolling/Page_INNSIGHT/Page_INNSIGHT/Page_INNSIGHT/Most Active Users'))

WebUI.click(findTestObject('scrolling/Page_INNSIGHT/Page_INNSIGHT/Page_INNSIGHT/Most Active us'))

CustomKeywords.'utilities.main.pause'()

WebUI.click(findTestObject('scrolling/Page_INNSIGHT/Page_INNSIGHT/Page_INNSIGHT/Author location'))
